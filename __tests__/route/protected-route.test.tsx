...
describe('ProtectedRoute', () => {
    ...
    it('renders component when user is authenticated and has required role', () => {
      ...
      const { getByText } = render(<ProtectedRoute component={() => <div>Protected Content</div>} roles={['admin']} />)
    ...
    it('renders component when no roles are required', () => {
      ...
      const { getByText } = render(<ProtectedRoute component={() => <div>Protected Content</div>} roles={undefined} />)
